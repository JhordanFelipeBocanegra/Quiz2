...
gcc -c linalg/source/RestaMatriz.c -o out/RestaMatriz.o
ar rcs out/liblinalg.a out/determinante2x2.o out/determinante3x3.o out/SumaMatriz.o out/RestaMatriz.o
